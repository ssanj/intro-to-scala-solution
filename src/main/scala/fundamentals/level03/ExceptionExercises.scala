...
/**
  ...
  */
  ...
  /**
    * Implement the function createValidPeople to create a List of Person instances from personStringPairs.
    * It should not throw any Exceptions. It should only catch Exceptions thrown by createPerson.
    *
